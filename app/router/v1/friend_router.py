...
async def get_friend_details(
    ...
    result = await friend_service.get_friend_details()
    return SuccessResponse(
        message=get_message("friend.getFriendDetails"),
        data=result,
    )
...
async def get_friend_list(
    ...
    return SuccessResponse(
        message=get_message("friend.getFriendList"),
        data=result,
    )
...
async def delete_single_friend(
    ...
    result = await friend_service.delete_single_friend(
        role=current_user.role, friend_list_id=friend_list_id
    )
    return SuccessResponse(
        message=get_message("friend.deleteSingleFriend"),
        data=result,
    )
